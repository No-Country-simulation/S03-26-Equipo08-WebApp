  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-indigo-100 selection:text-indigo-900">
      ...
      >
        ...
        >
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="w-full bg-gray-900 text-white font-black py-5 rounded-2xl shadow-2xl hover:bg-black transition-all active:scale-[0.98] flex items-center justify-center gap-3 group mt-8 relative overflow-hidden">
      ...
      >
         ...
         <span className="text-[10px] font-bold uppercase tracking-[0.3em]">Acceso Seguro vía Testimonial Hub</span>
      </motion.div>
    </div>
  );
}
